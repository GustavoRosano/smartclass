...
A aplicação foi publicada na Vercel com o objetivo de otimizar a entrega e proporcionar um ambiente de testes mais acessível: [SmartClass](https://smartclass-fase-3.vercel.app/)
